...
{
    HRESULT hr;
    ID3D11Texture2D* pBackBufffer;

    g_pSwapchain->GetBuffer(0, __uuidof(ID3D11Texture2D), (LPVOID*)&pBackBufffer);
    g_pDev->CreateRenderTargetView(pBackBufffer, NULL, &g_pRTView);
    pBackBufffer->Release();
